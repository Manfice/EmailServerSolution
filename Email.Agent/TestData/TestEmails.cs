...
namespace Email.Agent.TestData
{
    public class TestEmails
    {
        ...
        public TestEmails()
        {
            _emails.Add(new EmailData(DateTime.Today.AddDays(-10)) {Email = "c592@yandex.ru", Password = "1q2w3eOP", Login = "c592@yandex.ru", ImapServer = "imap.yandex.ru", Port = 993, Ssl = true});
            ...
            _emails.Add(new EmailData(DateTime.Today) {Email = "manfice@gmail.com", Password = "1q2w3eOP", Login = "manfice@gmail.com", ImapServer = "imap.gmail.com", Port = 993, Ssl = true});
        }
